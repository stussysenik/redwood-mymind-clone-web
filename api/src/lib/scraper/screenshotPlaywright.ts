...
function detectPlatform(url: string | null | undefined): Platform {
	...
	if (u.includes('mastodon') || u.includes('mathstodon') || u.includes('fosstodon') || u.includes('hachyderm.io')) return 'mastodon';
	...
	if (u.includes('amazon.com') || u.includes('amazon.co') || u.includes('amzn.')) return 'amazon';
	if (u.includes('thestorygraph.com') || u.includes('storygraph.com')) return 'storygraph';
