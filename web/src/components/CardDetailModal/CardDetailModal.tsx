        ...
        >
          ...
          >
            ...
            <div className="mb-6 pb-6 border-b border-gray-100 w-full">
              ...
              {isReAnalyzing && (
                <div className="mb-3 flex items-center gap-2.5 rounded-xl bg-orange-50 border border-orange-200 px-4 py-3 text-sm animate-pulse">
                  <Loader2 className="w-4 h-4 animate-spin text-[var(--accent-primary)]" />
                  <div>
                    <span className="font-medium text-orange-800">Analyzing with AI...</span>
                    <p className="text-xs text-orange-600 mt-0.5">Tags will appear when processing completes</p>
                  </div>
                </div>
              )}
